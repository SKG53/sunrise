// ============================================================================
// LEGACY — original single-spin Spin & Save (pre two-pool rebuild).
// Preserved verbatim for rollback per founder request (2026-09-10). NOT imported
// anywhere and NOT part of any bundle. To restore: point __root.tsx's SpinWheel
// import here (and rename this export back to SpinWheel), or copy this file over
// SpinWheel.tsx. Exact config as of HEAD 7779238.
// ============================================================================
...
export function SpinWheelLegacy() {
